...
start_time = time.time()
pos_arm, error_norm_pos, error_norm_rot = inverse_kinematics(kbotv2_for_ik.model, kbotv2_for_ik.data, temp_target_pos, target_ort=None, leftside=leftside, initialstate=initialstate)
